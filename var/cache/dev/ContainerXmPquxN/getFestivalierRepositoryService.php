 ...
 */
class getFestivalierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FestivalierRepository' shared autowired service.
     *
     * @return \App\Repository\FestivalierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FestivalierRepository.php';

        return $container->privates['App\\Repository\\FestivalierRepository'] = new \App\Repository\FestivalierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
