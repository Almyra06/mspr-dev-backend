...
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["concerts"]) || array_key_exists("concerts", $context) ? $context["concerts"] : (function () { throw new RuntimeError('Variable "concerts" does not exist.', 78, $this->source); })()));
...
\t\t\t\t\t<br/>";
            // line 82
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["concert"], "horaireDebut", [], "any", false, false, false, 82), "H:i"), "html", null, true);
            echo "
                    <br/>";
            // line 83
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["concert"], "horaireFin", [], "any", false, false, false, 83), "H:i"), "html", null, true);
            echo "</td>

\t\t\t\t<td>
\t\t\t\t\t";
            // line 86
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["concert"], "groupe", [], "any", false, false, false, 86), "nom", [], "any", false, false, false, 86), "html", null, true);
            echo "<br/>
\t\t\t\t\t";
            // line 87
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["concert"], "duree", [], "any", false, false, false, 87), "html", null, true);
            echo "<br/>
\t\t\t\t\t
\t\t\t\t\t";
            // line 89
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["concert"], "emplacement", [], "any", false, false, false, 89), "html", null, true);
            echo "
\t\t\t\t</td>
\t\t\t";
        }
...
";
    ...
    {
        return array (  222 => 97,  215 => 92,  206 => 89,  201 => 87,  197 => 86,  191 => 83,  187 => 82,  182 => 79,  178 => 78,  108 => 10,  98 => 9,  80 => 6,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "accueil/index.html.twig", "C:\\Program Files (x86)\\Cours\\cours\\Cours\\MSPR\\BACK-FRONT\\mspr-dev-backend2\\templates\\accueil\\index.html.twig");
    }
}
