...
class __TwigTemplate_93fa6a2b8c547aca08a865d23aaff4d22d849c29aeff9b54742590fa47b128bb extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<a href=\"";
            // line 53
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("live_events_accueil_admin_edit_concert", ["id" => twig_get_attribute($this->env, $this->source, $context["concert"], "id", [], "any", false, false, false, 53)]), "html", null, true);
...
";
    ...
    {
        return array (  200 => 67,  180 => 53,  174 => 50,  170 => 49,  166 => 48,  160 => 45,  156 => 44,  150 => 41,  146 => 39,  142 => 38,  113 => 11,  103 => 10,  90 => 7,  80 => 6,  60 => 3,  37 => 1,);
    }
...
\t\t\t\t\t\t</td>
\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t<a href=\"{{ path('live_events_accueil_admin_edit_concert', {'id': concert.id}) }}\" class=\"btn btn-link\">
\t\t\t\t\t\t\t\t<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"30\" height=\"30\" fill=\"currentColor\" class=\"bi bi-pencil\" viewbox=\"0 0 16 16\">
\t\t\t\t\t\t\t\t\t<path d=\"M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5L13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175l-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z\"></path>
\t\t\t\t\t\t\t\t</svg>
\t\t\t\t\t\t\t</a>
