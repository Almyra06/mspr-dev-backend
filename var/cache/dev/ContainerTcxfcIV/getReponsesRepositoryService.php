 ...
 */
class getReponsesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReponsesRepository' shared autowired service.
     *
     * @return \App\Repository\ReponsesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReponsesRepository.php';

        return $container->privates['App\\Repository\\ReponsesRepository'] = new \App\Repository\ReponsesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
