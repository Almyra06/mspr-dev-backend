 ...
 */
class getMessageUrgentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MessageUrgentRepository' shared autowired service.
     *
     * @return \App\Repository\MessageUrgentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessageUrgentRepository.php';

        return $container->privates['App\\Repository\\MessageUrgentRepository'] = new \App\Repository\MessageUrgentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
