 ...
 */
class getConcertRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConcertRepository' shared autowired service.
     *
     * @return \App\Repository\ConcertRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConcertRepository.php';

        return $container->privates['App\\Repository\\ConcertRepository'] = new \App\Repository\ConcertRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
