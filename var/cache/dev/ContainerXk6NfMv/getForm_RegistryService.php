...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\ConcertModifType' => ['privates', 'App\\Form\\ConcertModifType', 'getConcertModifTypeService', true],
            'App\\Form\\ConcertType' => ['privates', 'App\\Form\\ConcertType', 'getConcertTypeService', true],
            'App\\Form\\GroupeModifType' => ['privates', 'App\\Form\\GroupeModifType', 'getGroupeModifTypeService', true],
            'App\\Form\\GroupeType' => ['privates', 'App\\Form\\GroupeType', 'getGroupeTypeService', true],
            'App\\Form\\MessageModifType' => ['privates', 'App\\Form\\MessageModifType', 'getMessageModifTypeService', true],
            'App\\Form\\MessageType' => ['privates', 'App\\Form\\MessageType', 'getMessageTypeService', true],
            'App\\Form\\ProgrammeModifType' => ['privates', 'App\\Form\\ProgrammeModifType', 'getProgrammeModifTypeService', true],
            ...
            'App\\Form\\SearchConcertType' => ['privates', 'App\\Form\\SearchConcertType', 'getSearchConcertTypeService', true],
            ...
            'App\\Form\\ConcertModifType' => '?',
            'App\\Form\\ConcertType' => '?',
            'App\\Form\\GroupeModifType' => '?',
            'App\\Form\\GroupeType' => '?',
            'App\\Form\\MessageModifType' => '?',
            'App\\Form\\MessageType' => '?',
            'App\\Form\\ProgrammeModifType' => '?',
            'App\\Form\\ProgrammeType' => '?',
            'App\\Form\\QuestionType' => '?',
            'App\\Form\\RegistrationFormType' => '?',
            'App\\Form\\ReponseType' => '?',
            'App\\Form\\SearchConcertType' => '?',
