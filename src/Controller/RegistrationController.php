...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordEncoderInterface $passwordEncoder, GuardAuthenticatorHandler $guardHandler, UsersAuthenticator $authenticator): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('mspr.live.events@gmail.com', 'contact'))
                    ->to($user->getEmail())
    ...
    /**
     * @Route("/register/confirmation", name="app_confirmation_email")
     */
    public function confirmation(): Response
    {
        return $this->render('registration/confirmation_viatext.html.twig');
    }
}
